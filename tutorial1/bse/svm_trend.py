...
if __name__ == '__main__':
    ...
    #lfc_TestFeatures = (featMomentum, featHiLow, featMA, featEMA, featSTD, featRSI, featDrawDown, featRunUp, featVolumeDelta, featStochastic, featVolume, featBollinger)
    lfc_TestFeatures = [featMomentum]
    #default parameters
    ...
    t1 = datetime.now()
    #findBestCombination(dData, [[featHiLow]], lfc_TestFeatures, featTrend, ld_FeatureParameters)
