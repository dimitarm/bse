...
#lambda (dFullData): xxx(dFullData, lLookback = xx),
    lfc_TestFeatures = (
        ...
        lambda (dFullData): price.featSTDReturn(dFullData, lambd = 0.9),
        lambda (dFullData): price.featSTDReturn(dFullData, lambd = 0.84),
        lambda (dFullData): price.featSTDReturn(dFullData, lambd = 0.78),
        lambda (dFullData): price.featSTDReturn(dFullData, lambd = 0.9, bRel = True),
        lambda (dFullData): price.featSTDReturn(dFullData, lambd = 0.84, bRel = True),
        lambda (dFullData): price.featSTDReturn(dFullData, lambd = 0.78, bRel = True),
        ...
        lambda (dFullData): price.featEMAlambda(dFullData, lambd = 0.9, bRel = True),
        lambda (dFullData): price.featEMAlambda(dFullData, lambd = 0.84, bRel = True),
        lambda (dFullData): price.featEMAlambda(dFullData, lambd = 0.78, bRel = True),
