...
#lambda (dFullData): xxx(dFullData, lLookback = xx),
    lfc_TestFeatures = (
        ...
        lambda (dFullData): mom.featROCTradingRule(dFullData, lLookback = 22),
        ...
        lambda (dFullData): mom.featROCTradingRule(dFullData, lLookback = 9), 
        ...
        lambda (dFullData): price.featEMA(dFullData, lLookback = 24),
