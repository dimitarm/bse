...
class Test(unittest.TestCase):
    ...
    def testADL(self):
        dFullData = {}
        npClose = np.array([62.15,60.81,60.45,59.18,59.24,60.2,58.48,58.24,58.69,58.65,58.47,58.02,58.17,58.07,58.13,58.94,59.1,61.92,61.37,61.68,62.09,62.89,63.53,64.01,64.77,65.22,63.28,2.4,61.55,62.69])
