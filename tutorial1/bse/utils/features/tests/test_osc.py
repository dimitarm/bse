...
class Test(unittest.TestCase):
    ...
    def testMFI(self):
        ...
        dData['volume'] = pand.DataFrame(data={'aaaaaa': (18730.144,12271.74,24691.414,18357.606,22964.08,15918.948,16067.044,16568.487,16018.729,9773.569,22572.712,12986.669,10906.659,5799.259,
